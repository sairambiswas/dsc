...
import { RotateCcw, ShieldCheck, Lock, MapPin, Scale } from 'lucide-react';

const STORAGE_KEY = 'da_strength_club_v6_active';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fcfdfe] overflow-x-hidden">
      ...
      <main className="flex-1 container mx-auto p-4 lg:p-12 flex flex-col xl:flex-row gap-8 lg:gap-16 items-start justify-center">
        {isAdmin && (
          <aside className="xl:w-[420px] w-full space-y-8 animate-in fade-in slide-in-from-left-4">
          ...
          <div className="mt-20 max-w-xl w-full px-10 relative z-10">
            <div className="p-8 bg-slate-50 border border-slate-200 rounded-[40px] shadow-sm">
              ...
              <div className="space-y-4 opacity-70">
                <p className="text-[11px] font-bold text-slate-600 leading-relaxed uppercase tracking-tight">I. Members Only: This selection is reserved for verified Da Strength Club members.</p>
                <p className="text-[11px] font-bold text-slate-600 leading-relaxed uppercase tracking-tight">II. Secure Sync: Your result is automatically transmitted to the admin console.</p>
              </div>
            </div>
          </div>
        </div>
